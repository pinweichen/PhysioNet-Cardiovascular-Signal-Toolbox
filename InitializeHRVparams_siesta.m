function HRVparams = InitializeHRVparams(project_name, Sub_ID, foldID)
%
...
switch project_name   
    ...
    case 'shhs'                   % Update with your project name
        ...
        HRVparams.output.format = 'parquet';
    case 'siesta'                   % Update with your project name
...
if  isempty(HRVparams.writedata)    
    ...
    HRVparams.writedata = strcat(Sub_ID,'\',foldID);  
...
%HRVparams.output.format = 'parquet';        % 'csv' - creates csv file for output
