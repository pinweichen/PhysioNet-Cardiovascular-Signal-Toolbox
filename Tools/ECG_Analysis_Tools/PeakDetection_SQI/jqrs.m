function [qrs_pos,sign,en_thres] = jqrs(ecg,HRVparams)
...
% 03-03-2017
% Adriana Vest
% Changed formatting of input to take a settings struct and changed name of
% function to improve standardization.
% Old name: qrs_detect2.m
% New name: jqrs.m
%
